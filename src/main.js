...
const router=createRouter({history:createWebHashHistory(),routes:[{path:'/',component:()=>import('./views/Workspace.vue')},{path:'/video',component:()=>import('./views/Video.vue')},{path:'/library',component:()=>import('./views/Library.vue')},{path:'/presets',component:()=>import('./views/Presets.vue')},{path:'/history',component:()=>import('./views/History.vue')},{path:'/canvas',component:()=>import('./views/Canvas.vue')},{path:'/apis',component:()=>import('./views/ApiManagement.vue')},{path:'/settings',component:()=>import('./views/Settings.vue')} ]});
