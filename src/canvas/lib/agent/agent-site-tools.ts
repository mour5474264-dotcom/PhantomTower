...
import { videoResolutionOptions, videoSecondsRange, videoSizeOptions } from "@canvas/components/video-settings-panel";
import type { CanvasAgentSnapshot } from "@canvas/lib/canvas/canvas-agent-ops";
import { clampVideoSeconds } from "@canvas/lib/media-size";
