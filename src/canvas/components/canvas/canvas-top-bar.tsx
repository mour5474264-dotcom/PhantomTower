...
import { ArrowLeft, BookOpen, Download, Home, Images, Menu, PanelLeftClose, PanelLeftOpen, Plus, Redo2, Trash2, Undo2, Upload } from "lucide-react";
...
export function CanvasTopBar({
    ...
    onUndo: () => void;
    onRedo: () => void;
    /** Optional host-app exit. The canvas remains usable as a standalone module. */
    onExit?: () => void;
}) {
            ...
            <div className="pointer-events-none absolute left-0 right-0 top-0 z-50 flex h-16 items-center justify-between pl-1 pr-4">
                <div className="pointer-events-auto flex min-w-0 items-center gap-2">
                    ...
                    <Dropdown
                        ...
                        menu={{
                            items: [
                                ...(onExit ? [{ key: "exit", icon: <ArrowLeft className="size-4" />, label: "返回样片工厂", onClick: onExit }, { type: "divider" as const }] : []),
                ...
                <div className="pointer-events-auto flex items-center gap-1.5">
                    <UserStatusActions showConfig={false} variant="canvas" onOpenShortcuts={() => setShortcutsOpen(true)} onOpenPlugins={onOpenPlugins} />
                </div>
            </div>
