...
const store = localforage.createInstance({ name: "phantom-tower-canvas", storeName: "image_files" });
const imageLogStore = localforage.createInstance({ name: "phantom-tower-canvas", storeName: "image_generation_logs" });
const videoLogStore = localforage.createInstance({ name: "phantom-tower-canvas", storeName: "video_generation_logs" });
